...
const SPORSMAL: { q: string; a: string }[] = [
  { q: 'Må elevene logge inn?', a: 'Nei. Øvingen er innloggingsfri, og elever tar prøver ved å skrive inn prøvekoden fra læreren. Innlogging (Feide/Google) lar dem lagre fremgang, XP og samlekort.' },
