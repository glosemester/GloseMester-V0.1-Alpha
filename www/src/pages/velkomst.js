...
export const Velkomst = {
    async render() {
        ...
        // Hent siste resultater for elever
        let resultaterHtml = '';
        if (!erLaerer) {
        ...
        container.innerHTML = `
            <div style="
                min-height: 100vh;
                background: linear-gradient(160deg, #FFE8E3 0%, #fff 60%);
                padding: 0;
                display: flex;
            ...
            return `
                <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid #f3f4f6;">
                    <div style="
                        ...
                        font-size:15px;font-weight:900;color:${farge};flex-shrink:0;
                    ">${prosent}%</div>
                    <div style="flex:1;min-width:0;">
                        <div style="font-size:14px;font-weight:700;color:#1f2937;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
        ...
        return `
            <div style="padding: 0 20px 24px;">
                <div style="background:white;border-radius:20px;padding:20px;box-shadow:0 2px 16px rgba(0,0,0,0.06);">
                    <div style="font-family:'Outfit',system-ui;font-size:15px;font-weight:700;color:#1f2937;margin-bottom:4px;">
                        Mine siste prøver
                    </div>
                    ${rader}
                </div>
