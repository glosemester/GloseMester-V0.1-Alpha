        ...
        modal.innerHTML = `
            <div class="glass-card" style="max-width: 400px; width: 92%; text-align: center;">
                ...
                <button id="scan-qr-btn" onclick="window.FagStart.toggleQRScan('${fagType}')"
                    style="width:100%; padding:10px; background:rgba(255,107,71,0.08); border:1px dashed rgba(255,107,71,0.3); border-radius:10px; color:#FF6B47; font-weight:600; font-size:14px; cursor:pointer; margin-bottom:16px;">
                    📷 Scan QR-kode
                </button>
